...
-- ---------------------------------------------------------
-- File: migrate-auction-publish-gaps.sql
-- ---------------------------------------------------------
...
--
--   1. top_of_search â€” step-5 offers a paid "top of search" boost
...
--
--   2. carte_grise_front_url / carte_grise_back_url â€” step-4 uploads
...
-- backfill needed â€” existing rows get the defaults / NULLs.
-- ============================================================
...
-- Partial index mirrors auctions_featured_idx â€” the search ranker
...
--
-- We rebuild the function body's column list rather than ALTER it â€”
...
begin
  if exists (
    ...
    -- We append it by recreating the relevant UPDATE â€” but since the
    ...
    raise notice 'admin_patch_auction exists â€” column added; wire it into the whitelist in a future admin-sprint migration if needed';
  end if;
end $$;
