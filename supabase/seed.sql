...
insert into public.transactions (ref, user_label, type, direction, amount, label, status, created_at) values
  ...
  ('TX-G7H8', 'Mazed Auto',      'commission',    'in',  11760,   'Commission 3% — Mercedes E300',     'completed',  now() - interval '5 hours'),
  ...
  ('TX-Q7R8', 'Mazed Auto',     'commission',    'in',  4340,    'Commission 3% — Renault Kadjar',    'completed',  now() - interval '1 day'),
  ...
  ('TX-I5J6', 'Mazed Auto',     'commission',    'in',  6440,    'Commission 3% — Hyundai Tucson',    'completed',  now() - interval '12 days'),
  ...
  ('TX-O1P2', 'Mazed Auto',     'commission',    'in',  3080,    'Commission 3% — Dacia Duster',      'completed',  now() - interval '18 days'),
