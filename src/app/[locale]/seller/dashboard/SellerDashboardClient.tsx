...
// Client island for /seller/dashboard. AppShell wraps this from
// page.tsx (server) — see settings/SettingsClient.tsx for the same
// pattern. AppShell can't appear in "use client" bundles because it
// pulls lib/config which is server-only.
