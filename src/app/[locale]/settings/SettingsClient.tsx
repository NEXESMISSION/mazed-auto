...
// Client island for /settings. AppShell wraps it from the parent
// page.tsx (server) — keeping AppShell out of "use client" files is
// required to fix the Turbopack prod build, because AppShell pulls
// lib/config which uses next/headers (server-only).
