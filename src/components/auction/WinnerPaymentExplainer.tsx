 ...
 * pay → the car is officially yours; don't pay → caution forfeited + account
 * banned. This removes the "wait, what do I do / what's at stake?" confusion
 * the bare "Payer le solde" button left.
 *
      ...
      <div className="mt-3 space-y-2">
        <div className="flex items-start gap-2.5 rounded-xl bg-emerald-50 p-2.5 ring-1 ring-emerald-200">
          ...
          <span className="text-[12px] leading-snug text-emerald-900">
            <span className="font-bold">Si vous payez :</span> la voiture devient
            officiellement la vôtre — transfert de la carte grise à votre nom.
          </span>
        </div>
