...
export function KYCShell({
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      {/* ============================================================
          MOBILE — unchanged compact chrome
          ============================================================ */}
      ...
      {/* ============================================================
          DESKTOP — sticky app bar + centered content card
          ============================================================ */}
